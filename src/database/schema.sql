...
-- Tabela de Empregados (inclui técnicos e controladores)
...
-- Tabela de Técnicos (especialização de empregados)
CREATE TABLE IF NOT EXISTS tecnicos (
    numero_bi VARCHAR(20) PRIMARY KEY,
    FOREIGN KEY (numero_bi) REFERENCES empregados(numero_bi)
);

-- Tabela de Controladores (especialização de empregados)
...
-- Tabela de Especialidades dos Técnicos
